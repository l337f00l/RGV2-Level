print "A door toggled by the on/off switch, or whatever other trigger you want. (You can also have this appear when all sprites on-screen are destroyed, etc.)"
