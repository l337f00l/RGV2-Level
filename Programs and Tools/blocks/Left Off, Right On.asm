...
; and it wil block mario on the right side if the On/Off Switch is On
; Make it Act like Tile 130

print "Blocks Mario from the left if the ON/OFF switch is OFF, or from the right if the ON/OFF switch is ON"
