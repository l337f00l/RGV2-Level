...
!AllowNormalJumpAfterSpinJump = 1
...
!flags			= $0E70|!addr	; The wallkick flags. (RAM)
!no_back_timer		= $0E71|!addr	; The timer for not moving back. (RAM)
!temp_y_spd		= $0E72|!addr	; The temporary Y speed. (RAM)
...
.return2
  ...
  if !AllowSpinJump	
	...
	.kick
	if !AllowNormalJumpAfterSpinJump
	stz $140D|!addr
	endif
    LDA #!JumpSFX
