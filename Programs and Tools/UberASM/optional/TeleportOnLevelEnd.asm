...
; If Mario does the normal goal walk, the screen exit should be set for the screen that Mario ENDS at 
; when he STOPS the goal walk (not where the goal tape itself is).
; If it's an orb, obviously set the screen where the orb is. See more detail below.
